...
DEFINE_BITFIELD(bodyshape, list(
	...
	"BODYSHAPE_MERMAID" = BODYSHAPE_MERMAID,
))
...
DEFINE_BITFIELD(supports_variations_flags, list(
	"CLOTHING_NO_VARIATION_NEEDED" = CLOTHING_NO_VARIATION_NEEDED,
	"CLOTHING_DIGITIGRADE_SQUISH" = CLOTHING_DIGITIGRADE_SQUISH,
	"CLOTHING_DIGITIGRADE_VARIATION" = CLOTHING_DIGITIGRADE_VARIATION,
	"CLOTHING_CERULEAN_VARIATION" = CLOTHING_CERULEAN_VARIATION,
	"CLOTHING_LEGS_MASKING" = CLOTHING_LEGS_MASKING,
	"CLOTHING_BETWEEN_LEGS_MASKING" = CLOTHING_BETWEEN_LEGS_MASKING,
))
